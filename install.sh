...
ln -s $PWD/megapov/etc/megapov/1.2.1/povray.ini ../povray.ini
ln -s $PWD/megapov/etc/megapov/1.2.1/povray.conf ../povray.conf
...
cd ..
ln -s ./thirdparties/megapov/bin/megapov megapov
ln -s ./thirdparties/megapov/bin/povray povray
ln -s ./thirdparties/vlpovutils/vlpov_motionfield2 vlpov_motionfield2
